...
class Astar {
     ...
     */
     static void _insertOpenList(({Stop station, double f}) station, List<({Stop station, double f})> openList){
        int i;
     ...
     */
    static void _addOpenList (Stop stationBeing, Stop nextStation, Edge edge, Stop end, Map<Stop, ({Edge toFather, double f})> treeMap, Set<Stop> closedList, List<({Stop station, double f})> openList){
